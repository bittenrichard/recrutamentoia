...
const ScheduleModal = ({ isOpen, onClose, candidate, onSchedule }) => {
    ...
    return (<div className="fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 p-4">
            ...
            <div>
             ...
             <div className="pt-4">
              <label className="flex items-center">
                <input type="checkbox" checked={saveToGoogle} onChange={(e) => setSaveToGoogle(e.target.checked)} className="h-4 w-4 text-indigo-600 border-gray-300 rounded"/>
