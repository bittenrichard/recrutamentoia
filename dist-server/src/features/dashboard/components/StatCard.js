...
import { Briefcase, Users, CheckCircle2, Clock, Award } from 'lucide-react';
...
const StatCard = ({ title, value, iconName, iconColor, iconBg, onClick }) => {
    const Icon = iconMap[iconName] || Briefcase;
    const cardContent = (<div className="flex items-center text-left w-full">
    ...
    return (<div className="bg-white p-5 rounded-lg shadow-sm border border-gray-100 flex items-center">
      {cardContent}
    </div>);
};
