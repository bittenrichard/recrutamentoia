...
interface DailyEventsSidebarProps {
  ...
  vagaColorMap: Map<number, string>;
}

const DailyEventsSidebar: React.FC<DailyEventsSidebarProps> = ({ selectedDate, events, onViewDetails, vagaColorMap }) => {
            ...
            {events.map((event) => {
              ...
              return (
                <div
                  ...
                  className={`p-3 rounded-lg cursor-pointer flex items-start text-white shadow-sm hover:scale-[1.02] transition-transform duration-150 ease-out`}
