      ...
      <div className="rounded-md shadow-sm space-y-4">
        ...
        <div>
          ...
          <PhoneInput
            ...
            inputClass="!w-full !py-3 !px-3 !border !border-gray-300 !rounded-md focus:!ring-indigo-500 focus:!border-indigo-500 sm:!text-sm"
            containerClass="w-full"
            buttonClass="!border !border-gray-300 !rounded-l-md !bg-gray-50"
