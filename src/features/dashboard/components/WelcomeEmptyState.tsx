...
const WelcomeEmptyState: React.FC<WelcomeEmptyStateProps> = ({ onNewScreening }) => {
  return (
    <div className="text-center bg-white p-10 rounded-lg shadow-sm border border-gray-100 mt-8">
