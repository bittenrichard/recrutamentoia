...
import { Eye, MessageCircle, ChevronsUpDown, ArrowUp, ArrowDown, Loader2 } from 'lucide-react';
...
const CandidateTable: React.FC<CandidateTableProps> = ({ candidates, onViewDetails, isLoading = false, requestSort, sortConfig }) => {
