...
const KanbanBoard: React.FC<KanbanBoardProps> = ({ candidates, onUpdateStatus, onViewDetails, onScheduleInterview }) => {
  const columns = {
  ...
  return (
    <div className="flex gap-6 pb-2 overflow-x-auto h-full flex-grow hide-scrollbar">
        <KanbanColumn 
          columnId="Triagem" 
          title="Triagem" 
          candidates={columns['Triagem']} 
