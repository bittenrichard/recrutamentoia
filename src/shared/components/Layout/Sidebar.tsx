  ...
  return (
    ...
    `}>
      ...
      <div className="p-2 border-t border-gray-100">
        ...
        <button
          onClick={onToggle}
          className={`hidden md:flex items-center w-full p-3 mt-1 text-gray-600 hover:bg-gray-100 hover:text-gray-900 rounded-lg font-medium transition-colors ${isCollapsed ? 'justify-center' : ''}`}
